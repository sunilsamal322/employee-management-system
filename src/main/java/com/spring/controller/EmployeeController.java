...
import com.spring.security.EmployeeDetailsService;
...
public class EmployeeController {
    ...
    {
        Employee employee =employeeRepository.findByEmail(employeeDetailsService.getEmail()).orElseThrow(()->new EmailNotFoundException("Employee not found with "+employeeDetailsService.getEmail()));
